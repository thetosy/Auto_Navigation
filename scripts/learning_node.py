...
import sys
DATA_PATH = '/home/praise/catkin-ws/src/auto_nav/Data'
MODULES_PATH = '/home/praise/catkin-ws/src/auto_nav/scripts'
...
# temperature controls probability of picking non-optimal action
T_INIT = 25
T_GRAD = 0.95
T_MIN = 0.001

# probability of choosing a random action
# epsilon decay = epsilon * 0.96
EPSILON_INIT = 0.9
EPSILON_GRAD = 0.96 # epsilon decay
EPSILON_MIN = 0.05
